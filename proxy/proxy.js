...
(function() {
  ...
  server = http.createServer(function(req, res) {
    ...
    if (filename === "/") {
      ...
      filename += "index.html";
    } else if (((_ref = filename.slice(-4)) === '.gif' || _ref === '.mpg' || _ref === '.jpg' || _ref === '.css' || _ref === '.ico' || _ref === '.css' || _ref === '.png' || _ref === '.mov' ||  _ref === '.svg') || ((_ref1 = filename.slice(-3)) === '.js' || (filename !== 'robots.txt' && filename.slice(-4)) === '.txt' || (filename !== 'humans.txt' && filename.slice(-4)) === '.txt')  {
      try {
    ...
    } else if (filename.slice(-5) !== ".html" && filename.slice(-4) !== ".txt" && filename.slice(-4) !== '.ico' && filename.slice(-4) !== ".htm") {
      filename += ".html";
    }
